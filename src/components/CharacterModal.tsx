  ...
  const cleanDescription = (desc?: string) => {
    ...
    while (true) {
      ...
      cleaned = cleaned.replace(
        /^(__.*?__|<(strong|b)>.*?<\/(strong|b)>).*?(?=(__|<(strong|b)>|<br|\n|$))/i,
        "",
      );
      ...
      >
        ...
        <div className="w-full md:w-3/5 p-8 overflow-y-auto">
          <div className="mb-8 border-b border-zinc-800 pb-6">
            <h2 className="text-4xl md:text-5xl font-black font-cinzel text-white mb-2 tracking-tight">
              {character.name.full}
            </h2>
            <p className="text-xl text-rose-600 font-cinzel italic mb-4">
          ...
          <div className="prose prose-invert prose-rose max-w-none">
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: cleanDescription(character.description),
              }}
            />
          </div>
        </div>
